...
Related doc: see [RADAN_API_QUICK_INDEX.md](/c:/Tools/radan_automation/RADAN_API_QUICK_INDEX.md) for a topic-by-page index of `docs/Radan API Programming Help.pdf`.
