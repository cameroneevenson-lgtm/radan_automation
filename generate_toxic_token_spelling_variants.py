...
B37_VARIANTS: dict[str, list[TokenShiftPatch]] = {
    "b37_append_zero_deltas": [
        TokenShiftPatch("F54410-B-37", 12, 3, 0, 1, "append one zero to positive vertical delta"),
        TokenShiftPatch("F54410-B-37", 18, 3, 0, 1, "append one zero to negative vertical delta"),
    ],
    "b37_delta_signed2_z1": [
        TokenShiftPatch("F54410-B-37", 12, 3, 2, 1, "positive vertical delta plus two units and one zero"),
        TokenShiftPatch("F54410-B-37", 18, 3, -2, 1, "negative vertical delta minus two units and one zero"),
    ],
    "b37_start_y_m1_only": [
        TokenShiftPatch("F54410-B-37", 12, 1, -1, 0, "row 12 start Y minus one unit"),
    ],
    ...
    "b37_delta_signed4_z1_start_y_m1": [
        TokenShiftPatch("F54410-B-37", 12, 1, -1, 0, "row 12 start Y minus one unit"),
        TokenShiftPatch("F54410-B-37", 12, 3, 4, 1, "positive vertical delta plus four units and one zero"),
        TokenShiftPatch("F54410-B-37", 18, 3, -4, 1, "negative vertical delta minus four units and one zero"),
    ],
}

B38_SOURCE_LIKE_RESIDUAL_VARIANT = [
    TokenShiftPatch("F54410-B-38", 19, 0, -2, 0, "start X minus two units"),
    TokenShiftPatch("F54410-B-38", 19, 1, 1, 0, "start/end Y plus one unit"),
    TokenShiftPatch("F54410-B-38", 19, 3, 0, 1, "vertical delta spelling with one zero"),
    TokenShiftPatch("F54410-B-38", 22, 1, 1, 0, "Y plus one unit"),
    TokenShiftPatch("F54410-B-38", 22, 2, 1, 2, "horizontal delta plus one unit and two zeros"),
    TokenShiftPatch("F54410-B-38", 24, 0, -2, 0, "start X minus two units"),
    TokenShiftPatch("F54410-B-38", 24, 1, -2, 0, "Y minus two units"),
    TokenShiftPatch("F54410-B-38", 24, 2, 4, 1, "horizontal delta plus four units and one zero"),
    TokenShiftPatch("F54410-B-38", 29, 0, -1, 0, "start X minus one unit"),
    TokenShiftPatch("F54410-B-38", 29, 1, -1, 0, "Y minus one unit"),
    TokenShiftPatch("F54410-B-38", 29, 2, -12, 1, "horizontal delta minus twelve units and one zero"),
    TokenShiftPatch("F54410-B-38", 32, 0, 1, 0, "start X plus one unit"),
    TokenShiftPatch("F54410-B-38", 32, 2, 1, 2, "horizontal delta plus one unit and two zeros"),
    TokenShiftPatch("F54410-B-38", 34, 0, -1, 0, "start X minus one unit"),
    TokenShiftPatch("F54410-B-38", 34, 3, 0, 1, "vertical delta spelling with one zero"),
    TokenShiftPatch("F54410-B-38", 36, 0, -1, 0, "start X minus one unit"),
    TokenShiftPatch("F54410-B-38", 36, 1, -1, 0, "Y minus one unit"),
    TokenShiftPatch("F54410-B-38", 36, 2, 4, 1, "horizontal delta plus four units and one zero"),
    TokenShiftPatch("F54410-B-38", 198, 0, 2, 0, "start X plus two units"),
    TokenShiftPatch("F54410-B-38", 198, 1, -2, 0, "Y minus two units"),
    TokenShiftPatch("F54410-B-38", 198, 2, -12, 1, "horizontal delta minus twelve units and one zero"),
    TokenShiftPatch("F54410-B-38", 199, 0, -2, 0, "start X minus two units"),
    TokenShiftPatch("F54410-B-38", 199, 3, 0, 1, "vertical delta spelling with one zero"),
]
